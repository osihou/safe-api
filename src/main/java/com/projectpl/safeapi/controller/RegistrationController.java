...
public class RegistrationController {
    ...
    @PostMapping("/user/registration/store")
    public ModelAndView registerUserStoreAccount(
            @ModelAttribute("user") @Valid UserDto userDto,
            HttpServletRequest request,
            Errors errors
    ) {
        try {
            User registered = userService.registerNewUserStoreAccount(userDto);
    ...
    @PostMapping("/user/registration/client")
    public ModelAndView registerUserClientAccount(
            @ModelAttribute("user") @Valid UserDto userDto,
            HttpServletRequest request, Errors errors) {

        try {
            User registered = userService.registerNewUserClientAccount(userDto);
